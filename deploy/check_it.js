...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof process === "object" && typeof process.versions === "object" && typeof process.versions.node === "string" ) {
            ...
            var wasm_path = path.join( __dirname, "check_it.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "check_it.wasm", {credentials: "same-origin"} );
            ...
            return wasm_instance
                .then( function( wasm_instance ) {
                    ...
                    console.log( "Finished loading Rust wasm module 'check_it'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'check_it':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            ...
            "__cargo_web_snippet_656d3b4b5fe5a0444c593e06fb17e42fd9d8b81d": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);var name=($0);document.getElementById(name).pause();
            },
            ...
            "__cargo_web_snippet_714d58b7df422a1a51b24854c360c6efa9266ee9": function() {
                var xepher=document.createElement("AUDIO");xepher.setAttribute("src","xepher.mp3");xepher.setAttribute("id","xepher");document.body.appendChild(xepher);var karin=document.createElement("AUDIO");karin.setAttribute("src","karin.mp3");karin.setAttribute("id","karin");document.body.appendChild(karin);
            },
            ...
            "__cargo_web_snippet_e951830278cedfc68c607bfa56eff7c7b6a88bc1": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);var name=($0);document.getElementById(name).play();
            },
